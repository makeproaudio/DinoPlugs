...
def main():
  ...
  plistpath = scriptpath + "/resources/Scrollbar-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Scrollbar-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Scrollbar-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Scrollbar-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Scrollbar-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Scrollbar.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Scrollbar.iss",inplace=1):
