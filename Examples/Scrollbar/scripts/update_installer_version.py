...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Scrollbar Demo Installer\n"
      else:
        line="OutputBaseFilename=Scrollbar Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Scrollbar Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Scrollbar installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Scrollbar Demo installer\n"
     else:
       line="SetupWindowTitle=Scrollbar installer\n"
