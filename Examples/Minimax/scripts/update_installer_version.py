...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Minimax Demo Installer\n"
      else:
        line="OutputBaseFilename=Minimax Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Minimax Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Minimax installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Minimax Demo installer\n"
     else:
       line="SetupWindowTitle=Minimax installer\n"
