...
def main():
  ...
  plistpath = scriptpath + "/resources/Minimax-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Minimax-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Minimax-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Minimax-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Minimax-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Minimax.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Minimax.iss",inplace=1):
