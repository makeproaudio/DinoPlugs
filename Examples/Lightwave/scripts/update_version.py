...
def main():
  ...
  plistpath = scriptpath + "/resources/Lightwave-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Lightwave-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Lightwave-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Lightwave-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Lightwave-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Lightwave.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Lightwave.iss",inplace=1):
