...
def main():
  ...
  plistpath = scriptpath + "/resources/Prodyssey-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Prodyssey-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Prodyssey-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Prodyssey-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Prodyssey-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Prodyssey.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Prodyssey.iss",inplace=1):
