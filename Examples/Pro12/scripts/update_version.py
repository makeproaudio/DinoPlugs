...
def main():
  ...
  plistpath = scriptpath + "/resources/Pro12-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pro12-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pro12-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pro12-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pro12-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Pro12.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Pro12.iss",inplace=1):
