...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Pro12 Demo Installer\n"
      else:
        line="OutputBaseFilename=Pro12 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Pro12 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Pro12 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Pro12 Demo installer\n"
     else:
       line="SetupWindowTitle=Pro12 installer\n"
