...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Lightwave Demo Installer\n"
      else:
        line="OutputBaseFilename=Lightwave Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Lightwave Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Lightwave installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Lightwave Demo installer\n"
     else:
       line="SetupWindowTitle=Lightwave installer\n"
