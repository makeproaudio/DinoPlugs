...
def main():
  ...
  plistpath = scriptpath + "/resources/B4000-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/B4000-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/B4000-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/B4000-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/B4000-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/B4000.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/B4000.iss",inplace=1):
