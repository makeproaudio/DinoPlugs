...
#define AUV2_ENTRY DrumsNBass_Entry
#define AUV2_ENTRY_STR "DrumsNBass_Entry"
#define AUV2_FACTORY DrumsNBass_Factory
#define AUV2_VIEW_CLASS DrumsNBass_View
#define AUV2_VIEW_CLASS_STR "DrumsNBass_View"

#define AAX_TYPE_IDS 'EFN1', 'EFN2'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "DrumsNBass\nIPIS"
