...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumsNBass Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumsNBass Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumsNBass Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumsNBass installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumsNBass Demo installer\n"
     else:
       line="SetupWindowTitle=DrumsNBass installer\n"
