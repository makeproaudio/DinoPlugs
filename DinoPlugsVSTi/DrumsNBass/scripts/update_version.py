...
def main():
  ...
  plistpath = scriptpath + "/resources/DrumsNBass-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumsNBass-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumsNBass-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumsNBass-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumsNBass-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DrumsNBass.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DrumsNBass.iss",inplace=1):
