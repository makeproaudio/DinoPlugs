...
def main():
  ...
  plistpath = scriptpath + "/resources/FMagia-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMagia-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMagia-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMagia-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FMagia-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FMagia.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FMagia.iss",inplace=1):
