...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FMagia Demo Installer\n"
      else:
        line="OutputBaseFilename=FMagia Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FMagia Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FMagia installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FMagia Demo installer\n"
     else:
       line="SetupWindowTitle=FMagia installer\n"
