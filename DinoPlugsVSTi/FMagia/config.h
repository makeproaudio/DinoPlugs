...
#define PLUG_WIDTH 860
#define PLUG_HEIGHT 670
#define PLUG_FPS 60
#define PLUG_SHARED_RESOURCES 0

#define AUV2_ENTRY FMagia_Entry
#define AUV2_ENTRY_STR "FMagia_Entry"
#define AUV2_FACTORY FMagia_Factory
#define AUV2_VIEW_CLASS FMagia_View
#define AUV2_VIEW_CLASS_STR "FMagia_View"

#define AAX_TYPE_IDS 'EFN1', 'EFN2'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "FMagia\nIPIS"
