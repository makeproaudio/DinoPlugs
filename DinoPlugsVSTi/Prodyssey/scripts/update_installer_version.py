...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Prodyssey Demo Installer\n"
      else:
        line="OutputBaseFilename=Prodyssey Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Prodyssey Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Prodyssey installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Prodyssey Demo installer\n"
     else:
       line="SetupWindowTitle=Prodyssey installer\n"
