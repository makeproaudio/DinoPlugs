...
msbuild Prodyssey.sln -target:Prodyssey-vst2:Rebuild /p:configuration=release /p:platform=x64 /nologo /noconsolelogger /fileLogger /v:quiet /flp:logfile=build_errors.log;errorsonly;append
msbuild Prodyssey.sln -target:Prodyssey-vst2:Rebuild /p:configuration=release /p:platform=x64 /nologo /noconsolelogger /fileLogger /v:quiet /flp:logfile=build_errors.log;errorsonly;append
